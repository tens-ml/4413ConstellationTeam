package com.constellation.catalogservice.model;
...
public class Item {
    ...
    public static Item fromSellItemRequest(SellItemRequest sellItemRequest) {
        Item item = new Item();
        item.setSellerId(sellItemRequest.getSellerId());
        item.setName(sellItemRequest.getName());
        item.setDescription(sellItemRequest.getDescription());
        item.setIsDutch(sellItemRequest.getIsDutch());
        item.setInitialPrice(sellItemRequest.getInitialPrice());
        item.setAuctionEnd(sellItemRequest.getAuctionEnd());
        return item;
    }
}